            ...
            <SectionTitle
              ...
              subtitle={
                <p className="text-white/90">
                  A festa de Nossa Senhora Aparecida é celebrada anualmente em
                  12 de outubro, com novenas, procissão e programação especial.
                  Participe conosco deste momento de fé e devoção à Mãe
                  Aparecida.
                </p>
              }
              center
              ...
              <ul className="space-y-4 text-left">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      Novena em honra à Nossa Senhora Aparecida, às 19h30
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      Dias 11, 12 e 13 de Outubro, após as celebrações
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      Praça da Matriz e dependências da Paróquia
                    </p>
                  </div>
                </li>
              </ul>
