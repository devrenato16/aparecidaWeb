  ...
  const formTypes = [
    {
      ...
      description: 'Sacramento de iniciação cristã, pelo qual nos tornamos filhos de Deus.'
    },
    {
      id: 'catecismo',
      title: 'Catecismo',
      icon: <Users className="h-8 w-8" />,
      description: 'Preparação para a Primeira Eucaristia, destinada a crianças a partir de 9 anos.'
    },
    {
      id: 'crisma',
      title: 'Crisma',
      icon: <Award className="h-8 w-8" />,
      description: 'Sacramento que confirma o Batismo e fortalece os dons do Espírito Santo.'
    },
    {
      id: 'casamento',
      title: 'Casamento',
      icon: <Heart className="h-8 w-8" />,
      description: 'Sacramento que une homem e mulher em uma aliança indissolúvel perante Deus.'
    }
  ];
        ...
        <div className="container-custom">
          {!activeForm ? (
            ...
            <>
              ...
              >
                <SectionTitle 
                  title={`Inscrição para ${formTypes.find(f => f.id === activeForm)?.title}`}
                  subtitle="Preencha o formulário abaixo para realizar sua inscrição"
                  center
                />
                
                <div className="max-w-3xl mx-auto mt-10">
                  <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-8 rounded-lg shadow-elevation-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      {activeForm === 'batismo' && (
                        <>
                          <FormField
                            ...
                            options={{ required: 'O nome dos pais é obrigatório' }}
                          ...
                          <FormField
                            ...
                            options={{ required: 'O nome dos padrinhos é obrigatório' }}
                      ...
                      {activeForm === 'casamento' && (
                        <FormField
                          ...
                          options={{ required: 'O nome do(a) noivo(a) é obrigatório' }}
